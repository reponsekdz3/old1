...
config = {
    ...
    MESSAGE_QUEUE_URL = os.environ.get('MESSAGE_QUEUE_URL', REDIS_URL)
    CONNECTION_POOL_MIN_SIZE = 10
    CONNECTION_POOL_MAX_SIZE = 100
    BATCH_MESSAGE_INSERT_SIZE = 100
    CACHE_DEFAULT_TIMEOUT = 3600
    
    # CDN
    CDN_URL = os.environ.get('CDN_URL', 'https://cdn.bitese.app')
    CDN_REGIONS = os.environ.get('CDN_REGIONS', 'us-east,us-west,eu-west,ap-southeast').split(',')
